...
to migrate
  ask patches with [total-fish > 0] [
    ;repeat 10 [
      let good-neighbors patches in-radius 5 with [pxcor > [pxcor] of myself and (pycor = [pycor] of myself or pycor = [pycor] of myself + 4 or pycor = [pycor] of myself - 4) and in-boundary? = true] ;or pycor = [pycor] of myself + 1 or pycor = [pycor] of myself - 1)]
      ask good-neighbors [
